...
public class LisiActivity extends AppCompatActivity {
    ...
    private void initOnClick() {
        goBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LisiActivity.this.onBackPressed();
            }
        });
    ...
    private void initListView() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(LisiActivity.this, WebActivity.class);
                String path = Urls.CONTENT_URL + id;
                intent.putExtra("path", path);
                LisiActivity.this.startActivity(intent);
            }
        });
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder builder = new AlertDialog.Builder(LisiActivity.this);
                builder.setIcon(R.mipmap.ic_logo);
                final String title = ((Data) mMyTTAdapter.getItem(position)).getTitle();
                builder.setTitle(title);
                View view1 = LayoutInflater.from(LisiActivity.this).inflate(R.layout.delete_or_no, null);
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                int delete1 = db.delete(mLisiSQLiteHelper.getTableName(), "title=?", new String[]{title});
                                if (delete1 != 0) {
                                    initData();
                                    Toast.makeText(LisiActivity.this, "删除成功", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(LisiActivity.this, "删除失败", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
    ...
    private void initData() {
        mDatas.clear();
        SQLiteDatabase db = mLisiSQLiteHelper.getReadableDatabase();
        mCursor = db.query(mLisiSQLiteHelper.getTableName(), new String[]{"*"}, null, null, null, null, null);
